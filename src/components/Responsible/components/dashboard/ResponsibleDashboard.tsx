...
export const ResponsibleDashboard = ({ responsible }: { responsible: any }) => {
    ...
    const studentAllowToSeeOlympics = student.course == "Integral" ||
    student.course == "Berçário II / Maternal I" ||
    student.course == "Berçário II" || 
    student.course == "Maternal I" || 
    student.course == "Maternal II" || 
    student.course == "Pré-Escola I" || 
    student.course == "Pré-Escola II" || 
    student.course == '1º Ano' || 
    student.course == "2º Ano" || 
    student.course == "3º Ano" || 
    student.course == "4º Ano" || 
    student.course == "5º Ano" || 
    student.course == "6º Ano" || 
    student.course == "7º Ano" || 
    student.course == "8º Ano" || 
    student.course == "9º Ano" || 
    student.course == "1ª Série" || 
